    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-6 col-md-4 col-xs-5 col-5 menu">
                ...
                <ul class="nav_menu">
                    <a href="https://name-rp.ru/ru/home">
                    ...
                    <a href="https://name-rp.ru/ru/shop">
                        <li class="">Донат</li>
                    </a>
...
<section class="section__main">
    <img src="/img/layer_1.png" alt="" class="layer _1" data-aos="slide-left" data-aos-delay="600" data-aos-duration="3000">
    <img src="/img/layer_2.png" alt="" class="layer _2" data-aos="slide-left" data-aos-delay="400" data-aos-duration="3000">
    <img src="/img/layer_3.png" alt="" class="layer _3" data-aos="slide-left" data-aos-delay="200" data-aos-duration="3000">
    <img src="/img/person_main.png" alt="" class="person" data-aos="slide-left" data-aos-delay="700" data-aos-duration="2000">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="desc">
                    Текст который мы еще не придумали :(

                </div>
                <div class="actions">
                    <a href="https://name-rp.ru/ru/play" class="btn_start">начать игру!</a>
                    <ul class="social_links">
                        <li><a href="https://vk.com/namerp"><i class="fab fa-vk"></i></a></li>
                        <li><a href="https://www.youtube.com/c/"><i class="fab fa-youtube"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="server_block" onclick="copy('play.name-rp.ru')" data-toggle="tooltip" data-placement="top" title="Скопировать IP Адрес!">
                    <div class="server_number">01</div>
                    <div class="server_info">
                        <div class="name">Name RolePlay #1</div>
                        <div class="online"><div class="count">55</div>/ 1000</div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="modal_block login " id="VueLogin">
                ...
                <form action="https://namerp.ru/ru/profile/actionLogin" method="POST" id="formLogin" v-on:submit.prevent="onSubmit">
